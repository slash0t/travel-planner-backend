...
@Schema(description = "DTO для создания элемента списка задач")
public class CreateTodoItemDto {
    ...
    @Schema(description = "Статус выполнения задачи", example = "false", defaultValue = "false")
    private boolean completed = false;

    @Positive(message = "Позиция должна быть положительным числом")
    @Schema(description = "Позиция в списке (для сортировки)", example = "1")
