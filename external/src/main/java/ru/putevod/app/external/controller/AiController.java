...
public class AiController {
    ...
    public ResponseEntity<PackingListResponse> generatePackingList(@RequestBody PackingListRequest request) {
    ...
    public ResponseEntity<PackingListTemplateContent> getPackingListTemplateContent(@PathVariable String templateId) {
